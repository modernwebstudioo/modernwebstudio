        ...
        <div className="flex flex-col lg:flex-row gap-16 lg:gap-24 items-center">
          ...
          >
            <div className="bg-white/[0.03] backdrop-blur-3xl border border-white/[0.08] p-6 sm:p-8 md:p-12 rounded-[2rem] sm:rounded-[2.5rem] relative overflow-hidden group shadow-2xl">
              ...
              <form className="space-y-5 sm:space-y-6 relative z-10" onSubmit={(e) => e.preventDefault()}>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2.5">
                    ...
                    <select className="w-full bg-black/40 border border-white/10 rounded-2xl px-5 py-4 text-gray-300 outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500 transition-all font-light appearance-none">
